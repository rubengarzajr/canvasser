    ...
    this.getProps = function(type, name){
        authorData[type].forEach(function(finder){
            if (finder.name === name) {
                ...
                prop       = buildPropUI(prop, type, finder);
